  ...
  const filteredVendors = initialVendors.filter((vendor) => {
    ...
    const matchesCategory =
      ...
      (categoryFilter === "Other" &&
        !STANDARD_CATEGORIES.includes(vendor.category));
          ...
          <table className="w-full text-left text-sm text-slate-700">
            <thead>
              <tr className="border-b border-slate-200">
                ...
                <th className="pb-3 font-semibold text-slate-900">Phone</th>
                ...
                <div>
                  ...
                  <div className="space-y-4 bg-slate-50/50 p-5 rounded-xl border border-slate-100">
                    ...
                    <div>
                      ...
                      <span className="inline-block px-2.5 py-1 bg-indigo-50 text-indigo-700 text-xs rounded-full font-medium border border-indigo-100">
                ...
                <div>
                  ...
                  <div className="bg-slate-50/50 p-5 rounded-xl border border-slate-100">
                    ...
                    <p className="mt-2 text-xs text-slate-500">
                      Changing the status will immediately update the vendor's
                      access and visibility across the platform.
                    </p>
                  </div>
                </div>
              </div>
